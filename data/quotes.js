const comparisonQuotes = [
  ...
  {
    quote: "You know that the notion of beauty differs with every person. Something can be very beautiful to someone but not beautiful to other people. The notions of beauty, or ugliness--they are notions--and you are not affected by their opinions. ~ Thích Nhất Hạnh"
  },
  {
    quote: "You are a flower in the garden of humanity. You are not something less than a flower. ~ Thích Nhất Hạnh"
  },
  {
    quote: "Many millions of people misunderstood us and yet we still continued with our path, because we had belief in our values. I think if you continue to practice like that, you will be solid as a mountain. You will not be assaulted by any kind of opinions. ~ Thích Nhất Hạnh"
  },
  {
  ...
  {
    quote: "Comparing yourself to others is not only a habit but a habit that has become automatic. You probably don't realize you are doing it. Thus, one way to break the comparison habit is to bring awareness every time you do it: 'Ah, here is an unhelpful comparison thought!' ~ Psychology Today"
  },
  {
    quote: "Once you know when you are comparing, you can choose what you do with it. You can either take it on board, believe it to be true, or not. After all, it is just a thought like any other, and we can choose what thoughts we buy into based on whether they are helpful to us and help us move toward the life we want to live. ~ Psychology Today"
  },
  {
